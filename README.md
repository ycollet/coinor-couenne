...
# CMake files for compiling CoinOr / Couenne projects
## Introduction

How to use these cmake files ?

- Clone the repository
- Copy all the files from coinor-couenne to Couenne-0.5.7 (for example)
- In Couenne-0.5.7 create a build directory (mkdir build)
- In Couenne-0.5.7/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/couenne-0.5.7 -DCMAKE_BUILD_TYPE=RELEASE ..'
- In Couenne-0.5.7/build, launch 'cmake-gui .' to fine tune the configuration
...
$ tar xvfz Couenne-0.5.7.tgz
$ git clone https://github.com/ycollet/coinor-couenne.git
$ cp -r coinor-couenne/* Couenne-0.5.7/
$ cd Couenne-0.5.7
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/couenne-0.5.7 -DCMAKE_BUILD_TYPE=RELEASE ..
...
- Copy all the files from coinor-couenne to Couenne-0.5.7 (for example)
- In Couenne-0.5.7 create a build directory (mkdir build)
- In Couenne-0.5.7/build, launch 'cmake -DCMAKE_INSTALL_PREFIX=/opt/couenne-0.5.7 -DCMAKE_BUILD_TYPE=RELEASE -G "NMake Makefiles" ..'
- In Couenne-0.5.7/build, launch 'cmake-gui .' to fine tune the configuration
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/couenne-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang -DCMAKE_CXX_FLAGS="-fsanitize=memory" ..
# or
$ cmake -DCMAKE_INSTALL_PREFIX=~/couenne-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/usr/bin/clang++ -DCMAKE_C_COMPILER=/usr/bin/clang \ 
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=~/couenne-bin -DCMAKE_BUILD_TYPE=DEBUG -DCMAKE_CXX_COMPILER=/opt/intel/bin/icpc -DCMAKE_C_COMPILER=/opt/intel/bin/icc ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=d:/couenne-bin -DCMAKE_BUILD_TYPE=DEBUG -G "NMake Makefiles" ..
$ nmake
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/home/me/couenne-bin -DCMAKE_BUILD_TYPE=RELEASE -DCMAKE_TOOLCHAIN_FILE=cmake/mingw64-toolchain.cmake ..
$ make
```
...
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/couenne-devel -DCMAKE_BUILD_TYPE=RELEASE ..
$ make
...
$ coinbrew/coinbrew fetch --git --main-proj="Couenne"
$ cp -r ../coinor-couenne/* Couenne/
$ cd Couenne
$ mkdir build
$ cd build
$ cmake -DCMAKE_INSTALL_PREFIX=/opt/couenne-devel -DCMAKE_BUILD_TYPE=RELEASE ..
